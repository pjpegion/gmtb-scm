...
#define path to fv3 "fix" files
fix_dir='/scratch3/BMC/gsienkf/Philip.Pegion/FV3/fv3GFS/branches/chgres_fv3/fix/C96/'
#define path to initial condition
ic_dir='/scratch3/BMC/gsienkf/Philip.Pegion/FV3/ics/C96_L64/2014080100/mem001/'
...
infile1='%s/gfs_data.tile%i.nc' %(ic_dir,tilenum)
infile2='%s/updated_sfc_data.tile%i.nc' %(ic_dir,tilenum)
infile3='%s/C96_oro_data.tile%i.nc' %(fix_dir,tilenum)
infile4='%s/C96_grid.tile%i.nc' %(fix_dir,tilenum)
infile5='%s/gfs_ctrl.nc' %ic_dir
...
# open output file
nc = Dataset('../../data/processed_case_input/fv3_model_point2.nc', mode='w')
